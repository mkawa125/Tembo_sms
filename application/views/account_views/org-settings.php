            ...
            <div class="row" style="">
                <div class="col-sm-3 message_border">
                    <div class="box_message-acc">
                        ...
                        <a href="<?php echo base_url()?>index.php/Account_controller/org_settings"><button type="button" class="button-account button-account-selected"><i class="fa fa-cog" aria-hidden="true"></i>Organization setting</button></a>
                    </div>
