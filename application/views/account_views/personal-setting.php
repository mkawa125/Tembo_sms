    ...
    <div class="row" style="">
        <div class="col-sm-3 message_border">
            <div class="box_message-acc">
                ...
                <a href="<?php echo base_url()?>index.php/Account_controller/billing"><button type="submit" class="button-account "><i class="fa fa-credit-card" aria-hidden="true"></i>Billing</button></a>
            ...
            <div class="box_message-acc">
                ...
                <a href="<?php echo base_url()?>index.php/Account_controller/personal_settings"><button type="submit" class="button-account button-account-selected" ><i class="fa fa-user" aria-hidden="true"></i>Personal settings</button></a>
                ...
                <a href="<?php echo base_url()?>index.php/Account_controller/organizations"><button type="button" class="button-account "><i class="fa fa-globe" aria-hidden="true"></i>Organizations</button></a>
            </div>
        </div>
