    ...
    <div class="row">
        <div class="col-sm-2 incoming_navbar">
            ...
            <ul style="list-style: none">
                ...
                <li><a href="<?php echo base_url() ?>index.php/Redirect_controller/services">
                        <button type="button" class="navigation_button nav_selected"><i class="fa fa-server"
        ...
        <div class="col-sm-10">
            ...
            <div class="service_content">
                <a href="#">
                    <button type="button" class="btn btn-success" href="#">Text</button>
                </a>
                <a href="#">
                    <button type="button" class="btn btn-warning" href="#">Voice</button>
                </a>
                <ul class="list-group">

                    <li class="list-group-item">
                        <a href="#">
                            <div class="service-link">Subscription</div>
                            <div class="nyeusi">Let people subscribe or unsubscribe by sending an SMS keyword. <span
                    ...
                    <li class="list-group-item">
                        <a href="#">
                            <div class="service-link"> Auto-Reply</div>
                            <div class="nyeusi">Send an automatic SMS reply to incoming text messages or phone
                                calls.<span class="badge"></span></div>
                        </a></li>


                    <li class="list-group-item">
                        <a href="#">
                            <div class="service-link">Poll</div>
                            <div class="nyeusi">Ask one or more questions and collect responses via SMS. <span
                                        class="badge"></span></div>
                        </a></li>
                    ...
                    <li class="list-group-item">
                        <a href="#">
                            <div class="service-link">Webhook API</div>
                            <div class="nyeusi"> Notify your server via the Webhook API when an incoming message is
                                received.<span class="badge"></span></div>
                        </a></li>


                    <li class="list-group-item">
                        <a href="#">
                            <div class="service-link">Custom Actions</div>
                            <div class="nyeusi">Define actions to run automatically, and visually create logic
                                flows.<span class="badge"></span></div>
                        </a></li>


                    <li class="list-group-item">
                        <a href="#">
                            <div class="service-link">Cloud Script API</div>
                            <div class="nyeusi">Write a script to automatically handle incoming messages.<span
                                        class="badge"></span></div>
                        </a></li>
                </ul>
